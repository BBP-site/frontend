...
const Politics = () => (
  <main>
    <PageTitle title="Политика конфиденциальности (обработка персональных данных)" />
    ...
    >
      <p css={{ textAlign: 'justify' }}>
        Настоящая политика конфиденциальности (обработки персональных данных) (далее – Политика) составлена в
        соответствии с требованиями Федерального закона от 27.07.2006 № 152-ФЗ «О персональных данных» (далее - Закон о
        персональных данных) и определяет порядок обработки персональных данных и меры по обеспечению безопасности
        персональных данных, предпринимаемые Коллегией адвокатов города Москвы «Барщевский и Партнеры» (далее –
        Оператор). <br />
        ...
        которую Оператор может получить о посетителях веб-сайта bbp.ru.
      </p>
    </ContentSection>
    ...
    >
      <p css={{ textAlign: 'justify' }}>
        ...
        обеспечивающих их доступность в сети интернет по доменному имени bbp.ru и сетевому адресу https://www.bbp.ru/.
        <br />
        ...
        <br />
        2.10. Пользователь – любой посетитель Веб-сайта (субъект персональных данных).
        <br />
    ...
    <ContentSection
      ...
      css={{ paddingTop: '15px' }}
    >
      <p css={{ marginBottom: 0 }}>3.1. Оператор имеет право:</p>
    ...
    <ContentSection
      ...
      css={{ paddingTop: '15px' }}
    >
      <p css={{ marginBottom: 0 }}>4.1. Субъекты персональных данных имеют право:</p>
      <ul css={{ marginBottom: '0', textAlign: 'justify' }}>
        <li>
        ...
        <li>
          на отзыв согласия на обработку персональных данных в любой момент, путем направления Оператору уведомления
          посредством электронной почты на электронный адрес Оператора info1@bbp.ru с пометкой «Отзыв согласия на
      ...
      <p css={{ marginBottom: 0 }}>4.2. Субъект персональных данных обязан:</p>
      <ul css={{ marginBottom: '0', textAlign: 'justify' }}>
    ...
    >
      <p css={{ textAlign: 'justify' }}>
        ...
        перечень персональных данных, обработка которых подлежит прекращению. Указанные в данном требовании персональные
