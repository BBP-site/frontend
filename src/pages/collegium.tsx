    ...
    <>
        <p>
            <strong>
                ...
                адвокатских фирм
                России. Сегодня «Барщевский и Партнеры» - это профессиональная команда практикующих адвокатов и юристов,
                в числе
    ...
    first: (
        <>
            <p>
                ...
                Правительства Российской Федерации в Конституционном Суде Российской Федерации и Верховном Суде
                Российской
                Федерации, заслуженный юрист РФ, доктор юридических наук, профессор, Действительный государственный
                советник 1
                класса, обладатель высшей награды адвокатского сообщества России – золотой медали имени Ф.Н. Плевако,
                ордена «За
                верность адвокатскому долгу», а также кавалер орденов Почета и «За заслуги перед Отечеством» 4-й
                степени. Михаил
                Барщевский автор многочисленных книг и публикаций, в числе которых и художественные произведения, а
                также один
    ...
    second: (
        <>
            <p>
                ...
                госслужбу. С
                этого времени президентом Коллегии является Самвел Караханян – практикующий адвокат, член Адвокатской
                палаты
                города Москвы, доктор юридических наук, автор ряда публикаций, научных монографий и книг. Под его
                руководством
                работа Коллегии была неоднократно отмечена престижными наградами, включая национальную премию в области
                бизнеса
                «Компания года». Самвел Караханян - лауреат премий «Персона года 2009» (за вклад в развитие правового
                обеспечения экономических свобод) и «Персона года 2014» (в номинации «Юриспруденция»), кавалер
                Международного
