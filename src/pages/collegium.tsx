        ...
        <ContentSection css={{padding: '20px 0 48px 0', position: 'relative'}}>
            ...
            <div css={{...pageWrapS, position: 'absolute', bottom: '-6px', left: 0, right: 0, pointerEvents: 'none'}}>
                <div css={{position: 'relative', float: 'right'}}>
                    ...
                    <div
                        css={{width: '161px', height: '47px', backgroundColor: colors.blueDark, position: 'relative'}}/>
                </div>
            </div>
            ...
            <div css={{maxWidth: '1145px', paddingRight: '40px'}}>
                ...
                <p>
                    ...
                    IT-технологий,
                    ритейла, образования, энергетики, продажи и обслуживания автомобилей, здравоохранения. В последние
                    годы все
                ...
                <p>
                    ...
                    неотъемлемые
                    части жизни наших сотрудников. В нашей деятельности нам помогает взаимодействие со многими ведущими
                    научными
                ...
                <p css={{padding: '12px 16px 0px 16px', marginBottom: 0, backgroundColor: colors.blueLight}}>
                    ...
                    рейтингами, такими
                    как Право-300 в номинациях «уголовное право и процесс», «арбитражное судопроизводство», «разрешение
                    споров в
                ...
                <p css={{padding: '0px 16px 12px 16px', backgroundColor: colors.blueLight}}>
                    Коллегия адвокатов города Москвы «Барщевский и Партнеры» признавалась компанией года в 2004 и 2014
                    годах по
                    версии ежегодной бизнес - премии «Лучшие в России - компании и персоны года» в номинациях «За вклад
                    в развитие
                    правовой защиты российского бизнеса» и «Юридические услуги» Адвокаты Коллегии неоднократно отмечены
                    рейтингом
