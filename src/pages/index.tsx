    ...
    contentHtml: (
        <>
            ...
            <ul>
                ...
                <li>представление интересов доверителя на всех стадиях уголовного процесса (построение линии защиты на различных стадиях, сопровождение на стадии предварительного следствия, участие в деле в судах первой, апелляционной и кассационной инстанции);</li>
            ...
            <p>
                Ведение уголовного дела адвокатами Коллегии – это не только проработка правовой позиции, но и выстраивание верной линии поведения доверителя перед представителями правоохранительных органов, судом и прессой, оказание круглосуточной поддержки доверителю
                и его близким, сотрудничество с экспертными, оценочными организациями.
            </p>
        </>
    ),
    img: "./disputes.png",
...
const mediaServerData: IContent = {
    contentHtml: (
        <>
            <p>
                Партнёр КА г. Москвы «Барщевский и Партнёры» Михаил Вощинский специализируется на защите
            </p>
        </>
    ),
...
const projectMainServerData: IContent = {
    contentHtml: (
        <>
            <h5>
                Дело о включении в реестр кредиторов заведомо...
            </h5>
            <p>
                Долго совещаясь, коллегия судей согласилась с позицией адвокатов и отменила состоявшиеся судебные акты о включении требований в
            </p>
        </>
    ),
    date: '20.12.21',
