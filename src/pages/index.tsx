...
const Home = () => {
    const {mobileLg, tablet, tabletLg, tabletLgMin} = useMedia();
        ...
        <main>
            ...
            >
                ...
                >
                    ...
                    <p css={{[tabletLg]: {...typography.txtSm}}}>
                        Мы придерживаемся командного подхода и в рассмотрении вопроса доверителя, как правило, принимает
                        участие
            ...
            >
                ...
                >
                    <div>
                        ...
                        <p css={{[tabletLg]: {...typography.txtSm}}}>года мы оказываем профессиональную юридическую
                            помощь</p>
                    </div>
                    <div>
                        <p
            ...
            >
                <p css={{...typography.txtSm}}>
                    Наш профессионализм ежегодно подтверждается российскими и международными рейтинговыми агентствами, а
                    также
                ...
                >
                    {achievements.map(el => (
                        ...
                        >
                            {el.isHaveSize ? <Image src={el.img.src} width={el.width} height={el.height}/> :
                                <Image src={el.img}/>}
                        </div>
                    ))}
                </div>
