...
const Team: FC = () => {
    ...
    return (
        <main css={{width: '100%', ...typography.txt}}>
            <PageTitle title="Команда и парнеры">
                <p>
                    Адвокаты и юристы Коллегии адвокатов города Москвы «Барщевский и Партнеры»
                    сопровождают деятельность Клиентов, устраняя риски привлечения к ответственности
