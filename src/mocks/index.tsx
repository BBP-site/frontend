      ...
      contentHtml: (
        <>
          ...
          <p>
            ...
            <br /> {t('Заслуженный юрист РФ, д.ю.н., профессор')}
          </p>
          <div className="line" />
        </>
      ),
...
export const medias: IContentMedia[] = [
  {
    id: '167',
    name: 'Комментарий адвоката Коллегии Александры Вдовиной для ОТР',
    contentHtml: <></>,
    titleIcon: editURL,
  ...
  {
    id: '166',
    name: 'Управляющий партнер Елена Михалевич в индивидуальном рейтинге юристов от Право-300',
    contentHtml: <></>,
    titleIcon: globeURL,
  ...
  {
    id: '165',
    name: 'Статья адвоката Коллегии Марии Пуховой для Forbes: «Форс-мажор или риск: как российские суды меняют подход к санкциям»',
    contentHtml:
      '<p> Адвокат Коллегии Мария Пухова поделилась своим мнением с Forbes касательно перспектив признания судами санкций, ' +
      'вводимых иностранными государствами в 2022 – 2023 годах, форс-мажором. В статье раскрывается два подхода судов к этому вопросу. ' +
      'Так, в ряде случаев санкции однозначно признаются форс-мажором, освобождающим стороны от ответственности. ' +
      'Однако в последнее время в судебной практике все чаще встречается позиция, согласно которой суды относят санкции к предпринимательскому риску. ' +
      'Причина тому – отсутствие чрезвычайности,  поскольку санкционные ограничения в отношении России действуют еще с 2014 года. ' +
      '<a href="https://www.forbes.ru/mneniya/505415-fors-mazor-ili-risk-kak-rossijskie-sudy-menaut-podhod-k-sankciam">https://www.forbes.ru/mneniya/505415-fors-mazor-ili-risk-kak-rossijskie-sudy-menaut-podhod-k-sankciam</a>' +
      '</p>',
  ...
  {
    id: '161',
    name: 'Пополнение нашей команды. Новый член Коллегии -  адвокат Павел Хавкин.',
    contentHtml: <></>,
    titleIcon: globeURL,
    type: MEDIA_TYPE.NEWS_EVENT,
    date: '31.03.23',
  ...
  {
    id: '160',
    name: 'Поздравляем сотрудника Коллегии Марию Пухову с приобретением статуса адвоката!',
    contentHtml: <></>,
    titleIcon: globeURL,
    type: MEDIA_TYPE.NEWS_EVENT,
    date: '28.02.23',
  ...
  {
    id: '159',
    name: 'Управляющий партнер Коллегии, адвокат Елена Михалевич в очередной раз отмечена в персональном рейтинге Право – 300.',
    contentHtml: <></>,
    titleIcon: globeURL,
    type: MEDIA_TYPE.NEWS_EVENT,
    date: '21.02.23',
  ...
  {
    id: '158',
    name: 'Коллегия  традиционно вошла в рейтинг Право – 300.',
    contentHtml: <></>,
    titleIcon: globeURL,
    type: MEDIA_TYPE.NEWS_EVENT,
    date: '02.12.22',
  ...
  {
    id: '157',
    name: 'В Коллегии новый партнер - адвокат Татьяна Сперанская.',
    contentHtml: <></>,
    titleIcon: globeURL,
    type: MEDIA_TYPE.NEWS_EVENT,
    date: '01.09.22',
