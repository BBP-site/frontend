        ...
        <>
          ...
          <ul>
            ...
            <li>
              ...
              различных стадиях, сопровождение на стадии предварительного следствия, участие в деле в судах первой,
          ...
          <p>
            ...
            оказание круглосуточной поддержки доверителю и его близким, сотрудничество с экспертными, оценочными
            организациями.
          </p>
          <br />
      ...
      contentHtml: (
        <>
          ...
          <ul>
            ...
            <li>
              комплексное сопровождение на стадии вступления в наследство (представление интересов наследника у
              нотариуса, переговоры с другими наследниками и прочее);
            </li>
      ...
      contentHtml: (
        <>
          ...
          <p>
            ...
            отношений в спорах, связанных с дисциплинарными взысканиями (в т.ч. увольнением), с восстановлением на
            работе, о возмещении вреда, а также по защите коммерческой тайны и персональных данных и др.
          </p>
          <p>
            Большой блок нашей работы посвящен сотрудничеству с организациями по вопросам правовой поддержки в области
            трудовых правоотношений с учетом отраслевых и корпоративных особенностей, поскольку принятие превентивных
            мер позволит выстроить эффективное взаимодействие сторон трудовых отношений и минимизировать наступление
            судебных тяжб.
          </p>
          <br />
          ...
          <ul>
            ...
            <li>
              ...
              инструкций, положения о структурных подразделениях и иные документы);
            </li>
    ...
    },
    {
      ...
      contentHtml: (
        <>
          ...
          <p>
            Среди наших клиентов компании в сфере авиаперевозок, IT-технологий, ритейла, образования, энергетики,
            продажи и обслуживания транспортных средств, медицины.
          </p>
          <p>
          ...
          <p>
            ...
            возникновении вопросов адвокат может приступить к оказанию качественной юридической помощи незамедлительно,
            не тратя время на выяснение ситуации «с нуля».
          </p>
        </>
      ),
      img: practice5URL,
      ...
      contentHtml: (
        <>
          ...
          <p>
            ...
            примирению спорящих сторон путем подготовки и проведения процедуры медиации. Адвокаты Коллегии могут
            выступить как в роли представителя спорящей стороны, так и непосредственно в качестве медиатора –
            независимого лица.
          </p>
        </>
      ),
