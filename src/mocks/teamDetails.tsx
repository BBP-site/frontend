...
export const teamDetails: ITeamDetail[] = [
    {
        ...
        degreeCSS: {textAlign: 'center'},
        experienceHTML: (
            <>
                <p>
                    В настоящее время полномочный представитель Правительства Российской Федерации в Конституционном
                    Суде
                    Российской Федерации и Верховном Суде Российской Федерации, действительный государственный советник
                    1 класса.
                </p>

                <p>
                    Михаил Барщевский автор многочисленных книг и публикаций, в числе которых и художественные
                    произведения, а
    ...
    },
    {
        ...
        mediaHTML: (
            <>
                <p>
                    Караханян С.Г. имеет многочисленные статьи, в том числе монографии в области налогового, уголовного
                    права,
                    различных судебных споров, а также о профессиональной деятельности адвоката.
                </p>

                <p>
                    Караханян С.Г. О деятельности адвоката по защите налогоплательщиков в уголовном судопроизводстве:
                    Проблемы
                ...
                <p>
                    Караханян С.Г. Информационный компонент профессиональной компетентности адвоката. - М.: Издательство
                    «ОВЛ»,
                    2007.
                </p>

                <p>П. Баренбойм, С. Караханян, Д. Кравченко «Психологическая пытка в России и за рубежом» - М.: ЛУМ,
                    2016.</p>
    ...
    },
    {
        ...
        experienceHTML: (
            <>
                ...
                <p>
                    Отмечена в личном рейтинге Право.ру ТОП-300 как рекомендованные юристы в отрасли «Разрешение споров
                    в судах
        ...
        mediaHTML: (
            <>
                <p>
                    Автор книг «Обработка персональных данных: анализ законодательства и судебной практики» и «Как
                    сохранить
                    коммерческую тайну: анализ законодательства и практические рекомендации» издательства «Редакция
                    «Российской
                    газеты».
                </p>
                <p>
                    Имеет ряд научно-практических публикаций в профессиональных изданиях по вопросам защиты чести,
                    достоинства и
    ...
    },
    {
        ...
        practicesHTML: (
            <>
                ...
                <p>Имеет Благодарность Ивановской областной думы за добросовестный труд в области защиты прав
                    граждан.</p>
            </>
        ),
    },
    ...
    },
    {
        ...
        mediaHTML: (
            <>
                <p>
                    Автор ряда научных статей, посвященных уголовным и уголовно-процессуальным аспектам выявления и
                    расследования
